            ...
            <div className="flex-1">
              ...
              <div className="flex gap-3 mt-5">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 border border-gray-200 text-gray-600 text-sm font-medium rounded-full hover:bg-gray-50 transition-colors"
                  aria-label="URL 복사"
                >
